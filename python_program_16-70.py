...
Please Enter First String : janesh
Please Enter Second String : hasija
Your first string has become :-  hasija
Your second string has become :-  janesh
...
print(remove_spaces("J A N E S H "))
Acropolis
JANESH
...
print(get_max_occuring_char("Janesh"))
o
J
...
print(capitalize_first_last_letters("Janesh"))
AcropoliS
JanesH
